...
if __name__ == "__main__":
    ...
    for epoch in range(args.epochs):
        ...
        np.savetxt("training/CIFAR10AdaptiveThresholding_%d_%d_%d_%.1f_%d_%d_%d.txt" % (epoch+1, args.num_clauses, args.T, args.s, args.patch_size, args.max_included_literals, args.weighted_clauses), Y_test_scores, delimiter=',')

    np.savetxt("class_sums/CIFAR10AdaptiveThresholding_%d_ephocs.txt" % (args.epochs), Y_test_predicted, delimiter=',') 